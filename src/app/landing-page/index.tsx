...
const LandingPage = (props: Props) => {
  return (
    <PlausibleProvider domain={process.env.PLAUSIBLE_DOMAIN || ""}>
      <section className="flex flex-col items-center justify-center space-y-4 pt-4 sm:pt-24 w-full bg-[url('/images/app/back.png')] bg-cover bg-center bg-opacity-50" id="hero">
        <h1 className='text-4xl font-bold text-center tracking-tighter sm:text-5xl md:text-6xl leading-6'>Generate Smarter Forms <br></br>Instantly with AI</h1>
        <p className='max-w-[600px] mt-4 text-center text-gray-500 md:textl-xl'>
          Effortlessly generate, customize, and share your forms with AI. No hassle, just results.
        </p>
        <FormGenerator />
